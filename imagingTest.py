...
while(True):
    ...
    for x in range(180,0,-1):
        if(not inRange(frame[columnNumberForPipe][x][0], 85, 60) and \
           not inRange(frame[columnNumberForPipe][x][1],220,200) and \
           not inRange(frame[columnNumberForPipe][x][2],210,190)):
